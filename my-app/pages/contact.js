...
export default function Contact() {  
  return (
    <div className={`mt-14 lg:w-8/12 mx-auto ${castoro.className}`}>
      <h1 className="p-5 lg:pt-16 mx-auto md:text-2xl text-xl md:text-start text-center flex flex-row w-fit">Our Customer Service is always happy to help You!</h1>
        ...
        <h1 className="p-5 lg:pt-7 mx-auto md:text-2xl text-xl flex flex-row w-fit">Visit us!</h1> 
